...
<body>
  ...
  @media (max-width: 767px) {
    ...
    <section class="hero sticky-section sticky-content hero-section" id="home" data-aos="fade-up">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
    ...
    <section class="sticky-section about-section" id="about" data-aos="fade-up">
        <div class="container">
